...
find_my_print_defaults () {
  ...
  elif test -x C:/Program Files (x86)/MySql/MySQL Server 5.0/bin/my_print_defaults
  then
    print_defaults="C:/Program Files (x86)/MySql/MySQL Server 5.0/bin/my_print_defaults"
  elif test -x C:/Program Files (x86)/MySql/MySQL Server 5.0/bin/mysql_print_defaults
  then
    print_defaults="C:/Program Files (x86)/MySql/MySQL Server 5.0/bin/mysql_print_defaults"
  else
...
# Since we didn't find anything, used the compiled-in defaults
    ...
    MY_BASEDIR_VERSION=C:/Program Files (x86)/MySql/MySQL Server 5.0
