...
my $ldata   = 'C:/Program Files (x86)/MySql/MySQL Server 5.0/data';
my $execdir = 'C:/Program Files (x86)/MySql/MySQL Server 5.0/bin';
my $bindir  = 'C:/Program Files (x86)/MySql/MySQL Server 5.0/bin';
