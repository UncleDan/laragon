...
{
  $print_defaults='C:/Program Files (x86)/MySql/MySQL Server 5.0/bin/my_print_defaults';
}
...
{
  $opt->{basedir} = 'C:/Program Files (x86)/MySql/MySQL Server 5.0';
  $bindir         = 'C:/Program Files (x86)/MySql/MySQL Server 5.0/bin';
  $extra_bindir   = $bindir;
  $mysqld         = 'C:/Program Files (x86)/MySql/MySQL Server 5.0/bin/mysqld';
  $pkgdatadir     = 'C:/Program Files (x86)/MySql/MySQL Server 5.0/share';
  $scriptdir      = 'C:/Program Files (x86)/MySql/MySQL Server 5.0/bin';
}

unless ( $opt->{ldata} )
{
  $opt->{ldata} = 'C:/Program Files (x86)/MySql/MySQL Server 5.0/data';
}
  ...
  if ( !$opt->{'cross-bootstrap'} )
  {
    ...
    if ( !$opt->{rpm} )
    {
      report($opt,
             ...
             "",
             "  cd " . 'C:/Program Files (x86)/MySql/MySQL Server 5.0' . " ; $bindir/mysqld_safe &",
             "",
    ...
    report($opt,
           "Please report any problems with the " . 'C:/Program Files (x86)/MySql/MySQL Server 5.0/bin' . "/mysqlbug script!",
           "",
...
else
{
  error($opt,
        ...
        "And if you do mail us, you MUST use the " . 'C:/Program Files (x86)/MySql/MySQL Server 5.0/bin' . "/mysqlbug script!")
}
